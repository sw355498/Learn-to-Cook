...
@font-face {
  font-family: naikaifont;
  src: url(https://cdn.jsdelivr.net/gh/max32002/naikaifont@1.87/webfont/NaikaiFont-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/naikaifont@1.87/webfont/NaikaiFont-Regular.woff) format("woff");
}
```
